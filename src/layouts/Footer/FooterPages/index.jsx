                ...
                <div className="col-12 col-lg-4 col-md-6">
                  <div className="footer-copywrite-info">
                    <div className="copywrite_text fadeInUp" data-wow-delay="0.2s">
                      ...
                      <p>Join the DeFi revolution through our unique <br />WIZZ NFT Nodes. It's time to start a stable <br />passive income!.</p>
                      <p><b>Get your WIZZ Node today and earn a passive <br />income for up to 10 years.</b></p>
                    </div>
                  ...
                  <div key={key} className={item.classBlock}>
                    <div className="contact_info_area d-sm-flex justify-content-between">
                      <div className={item.classInfo} data-wow-delay="0.3s">
                        <h5>{item.title}</h5>
                        <a href={item.text1Href}><p>{item.text1}</p></a>
                        {item.text2 && <a href={item.text2Href}><p>{item.text2}</p></a>}
                        {item.text3 && <a href={item.text3Href}><p>{item.text3}</p></a>}
                        {item.text4 && <a href={item.text4Href}><p>{item.text4}</p></a>}
                        {item.text5 && <a href={item.text5Href}><p>{item.text5}</p></a>}
                      </div>
                    </div>
                  </div>
                ))}
